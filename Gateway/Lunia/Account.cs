...
namespace Soldin
{
    class Account
    {
        ...
        /// <summary>
        /// Gets or sets the list of characters associated with the account.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the character licenses of the account.
        /// </summary>
        public List<int> CharacterLicenses { get; set; }
